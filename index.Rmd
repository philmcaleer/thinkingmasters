...
This document was last updated on `r Sys.Date()` and was written and edited by Dr Phil McAleer (School of Psychology and Neuroscience, University of Glasgow). 
...
* this is a living document and may be updated at various intervals. The last date is shown above.
...
The last thing to know before we start looking at questions is the difference between core and optional modules. This one is fairly straighforward:
...
Note: As above the answers we provide to the below questions are the thinking and reasoning behind why you might want to ask that question, and not spe
